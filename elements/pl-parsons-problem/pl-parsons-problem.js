...
parsons.remove_indent_classes = function(id) {
    ...
    $('#' + id).removeClass('indent0 indent1 indent2 indent3 correct incorrect misaligned');
}
...
// };
    ...
    parsons.update_indent = function(leftDiff, id) {
        current_indent = parsons.indents[id] || 0;
        ...
        new_indent = Math.min(Math.max(0, new_indent), 3);
